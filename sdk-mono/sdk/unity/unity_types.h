...
struct Backend {
    static bool available() { return URK::mono::available(); }
    static const char* backend_last_error() { return URK::mono::last_error(); }
    ...
    static const void* find_class(std::string_view image, std::string_view ns, std::string_view name) { auto i=z(image), n=z(ns), c=z(name); return URK::mono::find_class(i.c_str(), n.c_str(), c.c_str()); }
    static const void* object_get_class(void* object) { return object ? URK::mono::object_get_class(static_cast<URK::mono::Object*>(object)) : nullptr; }
    static const char* class_get_name(const void* klass) { return klass ? URK::mono::class_get_name(static_cast<const URK::mono::Class*>(klass)) : nullptr; }
    static const char* class_get_namespace(const void* klass) { return klass ? URK::mono::class_get_namespace(static_cast<const URK::mono::Class*>(klass)) : nullptr; }
    static const void* find_method(const void* klass, std::string_view name, int argc) {
        ...
        while (current) {
            ...
            while (const auto* m = URK::mono::class_get_methods(static_cast<const URK::mono::Class*>(current), &it)) {
                const char* mn = URK::mono::method_get_name(m); if (!mn || n != mn) continue;
                const auto* sig = URK::mono::method_signature(m);
                if (argc < 0 || (sig && static_cast<int>(URK::mono::signature_get_param_count(sig)) == argc)) { match=m; ++matches; }
            }
    ...
    static const void* find_method_exact(const void* klass, std::string_view name, const std::vector<const char*>& parameterTypeNames) {
        ...
        while (current) {
            ...
            while (const auto* m = URK::mono::class_get_methods(static_cast<const URK::mono::Class*>(current), &it)) {
                const char* mn = URK::mono::method_get_name(m); if (!mn || n != mn) continue;
                const auto* sig = URK::mono::method_signature(m); if (!sig || URK::mono::signature_get_param_count(sig) != parameterTypeNames.size()) continue; ++same_arity;
                bool ok=true; for (std::uint32_t i=0; i<parameterTypeNames.size(); ++i) { char buf[256]{}; const auto* pt=URK::mono::method_get_param_type(m,i); const char* want=parameterTypeNames[i]; const bool named=URK::mono::type_get_name(pt, buf, sizeof(buf)); std::string_view got(named ? buf : ""); if (!want || !named || (!type_name_matches(got, want))) { if (first_mismatch.empty()) first_mismatch=std::string("; first mismatch param=")+std::to_string(i)+" requested="+(want?want:"<null>")+" actual="+(got.empty()?"<unavailable>":std::string(got)); ok=false; break; } }
    ...
    static int runtime_invoke(const void* method, void* object, void** params, void** result, void** exception) { return URK::mono::runtime_invoke(static_cast<const URK::mono::Method*>(method), static_cast<URK::mono::Object*>(object), params, result, exception); }
    static void* object_unbox(void* object) { return object ? URK::mono::object_unbox(static_cast<URK::mono::Object*>(object)) : nullptr; }
    static void* object_new(const void* klass) { return URK::mono::object_new(static_cast<const URK::mono::Class*>(klass)); }
    static void runtime_object_init(void* object) { URK::mono::runtime_object_init(static_cast<URK::mono::Object*>(object)); }
    static void* new_string(std::string_view text) {
        ...
        return URK::mono::new_string(std::string(text).c_str()); }
    static bool string_to_utf8(void* string, char* output, std::size_t outputSize) { return URK::mono::string_to_utf8(static_cast<URK::mono::String*>(string), output, outputSize); }
    static const void* find_field(const void* klass, std::string_view name) {
        ...
        while (current) {
            void* it=nullptr;
            while (const auto* f = URK::mono::class_get_fields(static_cast<const URK::mono::Class*>(current), &it)) { const char* fn = URK::mono::field_get_name(f); if (fn && n == fn) { std::lock_guard<std::mutex> lock(cache_mutex()); field_cache()[cacheKey] = f; return f; } }
            current = URK::mono::class_get_parent(static_cast<const URK::mono::Class*>(current));
        }
        return nullptr;
    }
    static bool field_get_value(void* object, const void* field, void* output) { return URK::mono::field_get_value(static_cast<URK::mono::Object*>(object), static_cast<const URK::mono::Field*>(field), output); }
    static void* field_reference_write_pointer(void*& reference) { return &reference; }
    static bool field_set_value(void* object, const void* field, void* value) { return URK::mono::field_set_value(static_cast<URK::mono::Object*>(object), static_cast<const URK::mono::Field*>(field), value); }
    static bool field_static_get_value(const void* klass, const void* field, void* output) { return URK::mono::field_static_get_value(static_cast<const URK::mono::Class*>(klass), static_cast<const URK::mono::Field*>(field), output); }
    static bool field_static_set_value(const void* klass, const void* field, void* value) { return URK::mono::field_static_set_value(static_cast<const URK::mono::Class*>(klass), static_cast<const URK::mono::Field*>(field), value); }
    static std::size_t array_length(void* array) { return URK::mono::array_length(static_cast<URK::mono::Array*>(array)); }
    static bool has_array_length() { return URK::mono::has_array_length(); }
    static bool has_array_ref_at() { return URK::mono::has_array_ref_at(); }
    static void* array_ref_at(void* array, std::size_t index) { return URK::mono::array_ref_at(static_cast<URK::mono::Array*>(array), index); }
    static void* array_addr_with_size(void* array, int elementSize, std::size_t index) { return URK::mono::array_addr_with_size(static_cast<URK::mono::Array*>(array), elementSize, index); }
    static bool has_array_set_ref() { return URK::mono::has_array_set_ref(); }
    static bool array_set_ref(void* array, std::size_t index, void* value) { return URK::mono::array_set_ref(static_cast<URK::mono::Array*>(array), index, value); }
    static std::uint32_t gchandle_new(void* object, int pinned) { return URK::mono::gchandle_new(object, pinned); }
    static std::uint32_t gchandle_new_weakref(void* object, int trackResurrection) { return URK::mono::gchandle_new_weakref(object, trackResurrection); }
    static void* gchandle_get_target(std::uint32_t handle) { return URK::mono::gchandle_get_target(handle); }
    static void gchandle_free(std::uint32_t handle) { URK::mono::gchandle_free(handle); }
    static void* type_object_for_class(std::string_view image, std::string_view ns, std::string_view name) { const void* k=find_class(image, ns, name); if (!k) return nullptr; auto* t = URK::mono::class_get_type(static_cast<const URK::mono::Class*>(k)); return t ? URK::mono::type_get_object(t) : nullptr; }
        static void* method_get_object(const void* method, const void*) { return URK::mono::method_get_object(static_cast<const URK::mono::Method*>(method), nullptr); }
    static void* value_box(const void* klass, void* data) { return URK::mono::value_box(static_cast<const URK::mono::Class*>(klass), data); }

    static std::int64_t string_length(void* string) { return static_cast<std::int64_t>(URK::mono::string_length(static_cast<URK::mono::String*>(string))); }
};
